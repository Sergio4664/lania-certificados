...
  /**
   * ✅ MODIFICACIÓN 1: Cambia el mensaje de confirmación para incluir el nombre del participante.
   */
...
  /**
   * ✅ MODIFICACIÓN 2: Cambia el mensaje de confirmación para incluir el nombre del destinatario del certificado.
   */
